...
# Map category name to new square image
mapping = {
...
for cat, img in mapping.items():
    old_str = f"foto: '../assets/productos/con_marco_blanco/galerias_con_marco/{cat}/img_1.jpg'"
    new_str = f"foto: '../assets/productos/con_marco_blanco/1_1_Cuadrado_1080x1080/{img}'"
    html = html.replace(old_str, new_str)

with open(html_path, 'w', encoding='utf-8') as f:
    f.write(html)
print("All covers fixed to be square!")
